...
-- with ARM.Strings.Search;

package body ARM.Strings.PString is
...
--        --  Case of Pstring and ARM_String
...
--        function "=" (Left : Pstring; Right : ARM_String)
--                       return Boolean is
--        begin
...
--        function "=" (Left : ARM_String; Right : Pstring)
--                       return Boolean is
--        begin
...
--           Temp : constant ARM_String (1 .. Max_Length) := Source.Data;
...
--        function To_String (Source : in Pstring) return ARM_String is
--        begin
--           return Source.Data (1 .. Source.Current_Length);
--        end To_String;

--        pstr20.ads:2:01: instantiation error at ARM-strings-pstring.adb:1225
