...
package body ARM.Strings.Maps is
...
--     is
--        --  Result : ARM_String (0 .. Map'Length - 1);
--        Result : ARM_String (0 .. 255);
--        J      : Unsigned_8;
...
--     is
--        Result : ARM_String (1 .. Character'Pos (Character'Last) + 1);
--        Count  : Unsigned_8 := 0;
