...
package ARM.Strings.PString is
   pragma Pure;
   ...
   generic
      ...
      --  Maximum length of a PString.  This implementation in the ARM
   ...
   package Generic_PString is
      ...
      function To_PString (Source : in ARM_String) return PString;
      function "+" (Source : in ARM_String) return PString
        renames To_PString;
      pragma Pure_Function (To_PString);

      --  function To_String (Source : in Pstring) return ARM_String;
