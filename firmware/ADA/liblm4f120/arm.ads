...
--  The package ARM is the parent for the AVR hierarchy.  It defines
...
package ARM is
   ...
   ARM_Ada_Version_Major : constant := 1;
   ARM_Ada_Version_Minor : constant := 0;
   ARM_Ada_Version_Patch : constant := 0;
