---------------------------------------------------------------------------
-- The ARM-Ada Library is free software;  you can redistribute it and/or --
-- modify it under terms of the  GNU General Public License as published --
-- by  the  Free Software  Foundation;  either  version 2, or  (at  your --
-- option) any later version.  The ARM-Ada Library is distributed in the --
...
package ARM.Strings.Edit is
   ...
   subtype Edit_Buffer_T is ARM_String (Edit_Index_T);
   ...
   procedure Put (Value   : Character;
                  ...
                  Fill    : Character := ' ');
   procedure Put (Value   : ARM_String;
                  Field   : All_Edit_Index_T := 0;
                  Justify : Alignment := Left;
                  Fill    : Character := ' ');
   procedure Put_Line (Value   : ARM_String;
                       Field   : All_Edit_Index_T := 0;
                       Justify : Alignment := Left;
                       Fill    : Character := ' ');
